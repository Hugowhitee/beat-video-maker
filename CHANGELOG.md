...
All notable changes to Beatvideo Maker. Weekly CalVer: `YYYY.MM.DD` = the Monday of the release week (Mon–Sun).
...
- Install Beatvideo Maker as a desktop app, with prompts when new versions ship
