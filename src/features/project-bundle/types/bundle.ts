 ...
 *
 * Defines the format for exportable/importable project bundles (.beatvideo.zip; legacy .freecut.zip remains importable)
 */
...
export const BUNDLE_EXTENSION = '.beatvideo.zip'
