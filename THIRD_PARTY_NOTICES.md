...
- Radix Icons — MIT License. The app mark adapts the Radix Mix icon path as a neutral editor glyph; it is not used as Beatvideo Maker brand identity outside the product UI.
